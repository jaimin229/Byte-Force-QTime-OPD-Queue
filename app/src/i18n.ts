...
export const STR: Record<Lang, Record<string, string>> = {
  ...
  hi: {
    ...
    orFollow: 'टोकन ट्रैक करें (तीमारदार / परिजन)',
    tokenNumber: 'टोकन संख्या',
    followDoctor: 'डॉक्टर चुनें',
    follow: 'कतार ट्रैक करें',
    myToken: 'मेरा टोकन',
    yourPosition: 'मरीज़ आपसे आगे हैं',
    youAreNext: 'आपका नंबर आ गया है — कृपया कमरा {room} में जाएं!',
    waitRange: 'अनुमानित प्रतीक्षा समय',
    min: 'मिनट',
    steppingOut: 'थोड़ी देर बाहर जा रहे हैं',
    stepOutDesc: 'जब आपसे आगे सिर्फ 5 मरीज़ रहेंगे, फोन पर अलर्ट आ जाएगा।',
    imBeingSeen: 'मेरा परामर्श शुरू हो गया',
    seenConfirmation: 'धन्यवाद! आपके कन्फर्मेशन से बाकी मरीज़ों का समय अपडेट हो गया।',
    goingForLab: 'लैब / एक्स-रे जांच के लिए जा रहे हैं',
    backToQueue: 'जांच से वापसी — कतार में पुनः जुड़ें',
    rejoinRule: '30 मिनट में लौटने पर आपका प्राथमिकता क्रम सुरक्षित रहेगा।',
    roomMoved: 'डॉक्टर का नया कमरा: रूम {room}',
    queuePaused: 'कतार अस्थायी रूप से रुकी हुई है',
    pausedReason: 'डॉक्टर आपातकालीन कॉल पर हैं। प्रतीक्षा समय रुका है, शुरू होने पर तुरंत अपडेट होगा।',
    ...
    patientName: 'मरीज़ का नाम / पहचान',
    showQR: 'यह QR कोड मरीज़ को दिखाएं',
    call: 'अगला मरीज़ बुलाएं',
    ...
    noticeText: 'प्रतीक्षा कक्ष व मरीज़ों के लिए संदेश',
    send: 'प्रसारित करें',
    room: 'कमरा',
    changeRoom: 'कमरा बदलें',
    nowServing: 'अभी परामर्श चल रहा है',
    nextUp: 'कतार में अगले मरीज़',
    liveBoard: 'लाइव ओपीडी बोर्ड',
    queueEmpty: 'कतार में कोई मरीज़ प्रतीक्षारत नहीं है',
    ...
    caregiverWatching: 'तीमारदार मोड — टोकन #{num} की निगरानी',
